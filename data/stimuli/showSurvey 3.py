import json, re                                                                                                                                                    
base = '/Users/danielhardt/Documents/GitHub/audio-focus-inference-research'                                                                                        
with open(f'{base}/data/stimuli/Inference_Survey_24.qsf') as f:                                                                                                    
    qsf = json.load(f)                                                                                                                                             
lookup = {}                                                                                                                                                        
for ns in ['ns1', 'ns2', 'ns3']:                                                                                                                                   
    with open(f'{base}/data/stimuli/{ns}.json') as f2:                                                                                                             
        items = json.load(f2)                                                                                                                                      
