...
Speaker 0 recorded all 100 items across f1–f10. The 24 ns items are drawn from 9 of those files (all except f7). Run the script on each:
...
python code/chunk_creation_of_any_audio.py --speaker speaker0 --file f3
...
python code/chunk_creation_of_any_audio.py --speaker speaker0 --file f8
