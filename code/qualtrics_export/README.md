...
- `build_focus_subset_from_clips.py`: builds a JSON subset from clip filenames like `f1_item0.wav`
...
Recommended workflow for `data/clips/set1/`:

```bash
python3 code/qualtrics_export/build_focus_subset_from_clips.py \
  data/clips/set1 \
